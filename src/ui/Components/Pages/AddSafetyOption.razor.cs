...
{
    public partial class AddSafetyOption
    {
        [Inject]
        ...
        {
            safetyOption = new CourseWork.Models.AutoDealership.SafetyOption();
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await AutoDealershipService.CreateSafetyOption(safetyOption);
