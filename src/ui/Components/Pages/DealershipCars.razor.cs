...
namespace CourseWork.Components.Pages
{
    public partial class DealershipCars
    {
        ...
        protected async Task Search(ChangeEventArgs args)
        {
            ...
            dealershipCars = await AutoDealershipService.GetDealershipCars(new Query { Expand = "AutoDealership,DealershipCarStatus" });
        }
                ...
                await AutoDealershipService.ExportDealershipCarsToCSV(new Query
{
    ...
    Expand = "AutoDealership,DealershipCarStatus",
