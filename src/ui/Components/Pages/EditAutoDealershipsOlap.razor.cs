...
{
    public partial class EditAutoDealershipsOlap
    {
        [Inject]
        ...
        {
            autoDealership = await AutoDealershipOLAPService.GetAutoDealershipById(Id);
        }
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await AutoDealershipOLAPService.UpdateAutoDealership(Id, autoDealership);
