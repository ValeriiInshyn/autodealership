...
{
    public partial class EditCarComfortOption
    {
        [Inject]
        ...
        {
            carComfortOption = await AutoDealershipService.GetCarComfortOptionByCarIdAndComfortOptionId(CarId, ComfortOptionId);
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await AutoDealershipService.UpdateCarComfortOption(CarId, ComfortOptionId, carComfortOption);
