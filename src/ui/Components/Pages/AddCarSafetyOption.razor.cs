...
{
    public partial class AddCarSafetyOption
    {
        [Inject]
        ...
        {
            carSafetyOption = new CourseWork.Models.AutoDealership.CarSafetyOption();
        ...
        protected async Task FormSubmit()
        {
            try
            {
                await AutoDealershipService.CreateCarSafetyOption(carSafetyOption);
